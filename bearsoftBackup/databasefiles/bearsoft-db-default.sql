...
(1, 'username', 'password', 1, 'dsdsds', 'http://localhost:5173', '650000', 'apimelimayamak', 'bearsoft,بیرسافت,حسابداری ابری رایگان,حسابداری آنلاین رایگان,حسابداری,نرم افزار حسابداری,نرم افزار حسابداری مغازه,نرم افزار حسابداری تحت وب رایگان', 'بیرسافت اولین نرم افزار حسابداری ابری رایگان و متن‌باز است که امور مالی شما را به صورت سریع و ساده انجام می‌دهد.بیرسافت کاملا متن باز است.', NULL);
